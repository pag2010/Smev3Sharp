...
namespace Smev3Client.Smev
{
        ...
        ISmev3Envelope
    {
        ...
        private readonly SoapEnvelope<GetRequestRequest> _soapEnvelope;
            ...
            ISmev3XmlSigner signer)
        {
            ...
            _soapEnvelope = new SoapEnvelope<GetRequestRequest>
            {
                Header = new SoapEnvelopeHeader
                {
                    Action = new SoapAction(nameof(Smev3Methods.GetRequest))
                },
                Body = this
            };
        }
        ...
        {
            writer.WriteStartElement("GetRequestRequest", Smev3NameSpaces.MESSAGE_EXCHANGE_TYPES_1_2);
